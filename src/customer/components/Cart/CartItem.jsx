        ...
        <div className='flex items-center'>
            ...
            <div className='ml-5 space-x-1'>
                ...
                <div className="flex space-x-5 items-center text-gray-900 pt-6">
                    ...
                    <p className="opcaity-50 line-through">₹{item.discountedPrice}</p>
                    <p className="text-green-600 font-semibold">{item.discountPersent}% Off</p>
              </div>
            </div>
        </div>
        <din className='lg: flex items-center lg:space-x-10 pt-4'>
                ...
                <div>
                    <Button onClick={handleRemoveCartItem} sx={{color:"RGB(145 85 153)"}}>remove</Button>
                </div>
            </din>
    </div>
  )
